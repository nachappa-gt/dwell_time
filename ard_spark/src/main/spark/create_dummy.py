...
"""SPARK_MAJOR_VERSION=2 spark-submit --master yarn --queue ard --driver-memory 2g --executor-memory 4g --num-executors 4 --packages com.databricks:spark-avro_2.11:3.2.0 create_dummy.py"""
