...
from xad.dwell_time.dispatcher import Dispatcher
...
DEFAULT_ALERT_EMAIL = 'nachappa.ponnappa@groundtruth.com'
...
COMMANDS:
    ...
    aliases can be found in the configuration file:

        /home/xad/dwell_time/config/commands.properties
