...
class BaseDT(OptionContainer):
    ...
    # Path
    #---------
    # def getHDFSUserTmpDir(self, app='dwell_time', tmpRoot='/tmp'):
    #     """Get a user-specific tmp directory, e.g. /tmp/dwell_time-xad."""
